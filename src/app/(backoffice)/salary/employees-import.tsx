...
import { importEmployeesExcel } from "./actions";
...
export function EmployeesImport() {
  ...
  function onFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    fd.append("file", file);
    start(async () => {
      const res = await importEmployeesExcel(fd);
      if (res.ok) {
        setMsg({
          ok: true,
          text: `✓ ${res.inserted} ажилтан нэмлээ${res.skipped ? ` (${res.skipped} давхардсан мөр алгассан)` : ""}.`,
        });
        router.refresh();
      } else {
  ...
  return (
    <div className="no-print">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <a
          href="/salary/employees/template"
