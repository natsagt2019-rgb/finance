...
//
// ХАРИЛЦАГЧТАЙ гүйлгээ: данс + ОГНОО(цаг үл хамаарна) + харилцагч + тайлбар + дүн.
//   → Банк нэг гүйлгээг өөр экспортод 8 цагаар зөрүүтэй timestamp-аар гаргадаг
//     (timezone re-export). Бүтэн timestamp ашиглавал эдгээр давхардана. Огноо
//     ашиглавал барина (8 цагийн шилжилт ихэвчлэн нэг өдрийн дотор).
//   → Харилцагчийг түлхүүрт ОРУУЛНА — ингэснээр ижил дүн/тайлбартай ч ӨӨР хүнд
//     хийсэн бодит гүйлгээ (ж: 2 ажилтны урьдчилгаа цалин) хуурамчаар нэгдэхгүй.
// ХАРИЛЦАГЧГҮЙ (банкны жижиг шимтгэл): бүтэн timestamp — нэг өдөр олон ижил
//   шимтгэл зөвхөн цагаар ялгардаг тул.
//
// Тайлбар/харилцагчийн зайг нормчилно (tab/олон зай → нэг зай): парсер хувилбар
// бүр өөр өөрөөр тавьдаг ("K3⇥..." vs "K3␣␣␣...") тул нормчлохгүй бол давхардана.
// Тэмдэглэл: харилцагчийн нэр өөрөө хувилбар хооронд өөрчлөгдвөл (ж: "ЦЭЦЭНС
// МАЙНИНГ" → "...ЭНД ЭНЕРЖИ") тэр ховор тохиолдолд 1 давхардал мултарч болзошгүй
// — find-duplicates.mjs-ээр илрүүлж цэвэрлэнэ.
function fingerprint(
  ...
  const cp = (counterparty ?? "").trim().toLowerCase().replace(/\s+/g, " ");
  if (cp) {
    const dateOnly = new Date(txnDate).toISOString().slice(0, 10);
    return [accountId, dateOnly, cp, desc, inc, exp].join("|");
  }
