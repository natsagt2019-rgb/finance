...
import { importAssetsExcel } from "./actions";
...
export function AssetsImport() {
  ...
  function onFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    fd.append("file", file);
    start(async () => {
      const res = await importAssetsExcel(fd);
      if (res.ok) {
        setMsg({
          ok: true,
          text: `✓ ${res.inserted} хөрөнгө нэмлээ${res.skipped ? ` (${res.skipped} давхардсан нэр алгассан)` : ""}. Доорх жагсаалт шинэчлэгдэнэ — «Журналд тусгах» дарж эхний үлдэгдлийг бичнэ.`,
        });
        router.refresh();
      } else {
  ...
  return (
    <div className="print:hidden">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <a
          href="/opening-balances/assets/template"
