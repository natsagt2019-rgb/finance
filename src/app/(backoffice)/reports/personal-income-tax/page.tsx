    ...
    <div>
      ...
      <div className="mx-auto max-w-4xl rounded-2xl border border-zinc-200 bg-white p-8 text-sm leading-6 text-zinc-800 print:max-w-none print:rounded-none print:border-0 print:p-0">
        ...
        <p className="mt-2 text-[11px] text-zinc-500">
          ...
          хөнгөлөлтийг сар бүр тооцохгүй — <b>зөвхөн жилийн эцэст (12-р сар)</b>
          жилийн өссөн татвар ногдуулах орлогоор нэг дор эдлүүлнэ (Хуулийн 25.5,
          27.1). <b>Резидент бус (гадаад):</b> Нийт цалин × 20% (20.1, 21.2.5; НДШ
