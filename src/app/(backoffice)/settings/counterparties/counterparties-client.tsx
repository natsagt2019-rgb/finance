    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-zinc-200 bg-white p-4">
        ...
        <p className="mt-1 text-sm text-zinc-500">
          <b>A багана</b> = харилцагчийн нэр, <b>B багана</b> = харьцсан дансны
          дугаар. Толгой мөр автоматаар алгасагдана. Нэг данс олон нэртэй бол
          олонхын нэрийг авна. Байгаа дансыг шинэчилж, шинийг нэмнэ.
        </p>
