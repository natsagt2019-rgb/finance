...
const STEPS: Step[] = [
  ...
  },
  {
    href: "/import",
    icon: "↧",
    title: "4. Дансны хуулга оруулах",
    desc: "Банкны хуулгаа Excel/CSV-ээр импортлож цэгцэлнэ. Дараа нь «Дансны хуулга» (₮) цэсээс харна.",
  },
  {
    href: "/categorize",
    icon: "✨",
  ...
  },
  {
    href: "/journals",
    icon: "📒",
    title: "6. Журнал бичих",
    desc: "Автоматаар үүсээгүй гүйлгээг (тохируулга, цалин, элэгдэл г.м.) гар журналаар Дт/Кт-оор бичнэ.",
  },
  {
    href: "/reports/balance-sheet",
    icon: "📊",
    title: "7. Тайлан харах",
    desc: "Гүйлгээ баланс, Санхүүгийн байдал, Орлогын тайлан зэргийг зүүн цэсний «Тайлан» хэсгээс гаргана.",
  },
];
      ...
      <header className="flex items-start justify-between gap-3 border-b border-blue-100 px-5 py-4">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-600">
            Анх ороход дата хоосон байна. Доорх дарааллаар тохируулж эхэлбэл хамгийн хялбар.
            Бүх модуль <span className="font-medium">зүүн талын цэс</span>-нд байрлана.
          </p>
        </div>
        <button
          type="button"
