-- ============================================================
-- ШИНЭ КОМПАНИЙН БҮРЭН SETUP (нэг хуулаад тавих)
...
-- Бохир Дт/Кт эргэлт (turn_dt/turn_kt)-ийг мужид нэмж буцаана — тайлангийн
-- «Гүйлгээ» багана эдгээрийг харуулна (зөвхөн цэвэр closing-opening биш).
DROP FUNCTION IF EXISTS trial_balance_range(DATE, DATE);
...
INSERT INTO category_gl_map (company, category_code, side, gl_code, note) VALUES
  ...
  -- Зарлага (Дт)
  ('TT', '1.2.1', 'debit', '610201', 'Тээврийн зардал (одоогийн сар)'),
  ('TT', '1.2.2', 'debit', '610201', 'Тээврийн зардал (өмнөх сар)'),
