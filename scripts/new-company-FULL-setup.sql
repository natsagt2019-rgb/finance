-- ============================================================
-- ШИНЭ КОМПАНИЙН БҮРЭН SETUP (нэг хуулаад тавих) — БҮТЭЦ + ДАНСНЫ ТӨЛӨВЛӨГӨӨ
-- ============================================================
-- Шинэ Supabase project үүсгээд, ЭНЭ ФАЙЛЫГ БҮХЭЛД НЬ SQL Editor-д хуулж
-- ажиллуулна. Дараах зүйл үүснэ:
--   1) Бүх хүснэгт, view, RPC, индекс (гүйлгээ ОРОХГҮЙ — цэвэр)
--   2) Стандарт IFRS/СБТ дансны төлөвлөгөө (138 данс: 130100 авлага,
--      310100 өглөг, 130600/330100 НӨАТ — апп-ийн кодтой таарна)
-- Дансны төлөвлөгөө нь accounts хүснэгт ХООСОН үед л орно (давхар орохгүй).
--
-- ДАРАА НЬ (заавал биш):
--   • Тохиргоо → Банкны данс: банкны дансаа бүртгэх
--   • Тохиргоо → Ангилал → данс зураглал: AI авто-кодлолт
--   • /opening-balances: эхний үлдэгдэл оруулах
-- Автоматаар угсарсан: scripts/_build-full.mjs
-- ============================================================
...
-- ════════════════════════════════════════════════════════════
-- ДАНСНЫ ТӨЛӨВЛӨГӨӨ (accounts-standard-seed.sql)
-- ════════════════════════════════════════════════════════════
-- ==========================================================
